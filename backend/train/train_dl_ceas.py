...
# 📁 Paths
DATA_PATH = "data/processed/email_dataset_cleaned.csv"
EMBEDDING_PATH = "data/embeddings/glove.6B.100d.txt"
MODEL_DIR = "models/ceas"

MODEL_SAVE_PATH = os.path.join(MODEL_DIR, "spam_classifier_dl.keras")
TOKENIZER_SAVE_PATH = os.path.join(MODEL_DIR, "tokenizer_dl.pickle")
