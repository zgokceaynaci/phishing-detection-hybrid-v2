# src/train/train_email_dl_model.py
...
MODEL_SAVE_PATH = "models/combined/spam_classifier.keras"
TOKENIZER_SAVE_PATH = "models/combined/tokenizer.pickle"
